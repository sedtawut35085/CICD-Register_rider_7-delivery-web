        ...
        <div>
            <nav className="bg-white border-gray-200 px-0 sm:px-4 py-1 rounded dark:bg-gray-900 border-b-2 ">
                <div className="md:px-5 py-1 flex flex-wrap justify-between items-center mx-auto">
                    ...
                    <div className="flex items-center md:order-2 dropdown-2">
                        ...
                        <div className="absolute mt-8 ml-8 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
                            <ul className={`dropdown-menu text-gray-900 pt-0    ${style ? "hidden" : "block"}`} >
                                <li className="-mb-2">
