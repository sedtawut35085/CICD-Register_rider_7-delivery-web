...
import ModelComponent from '../ModelPdpa';
...
const PreliminaryComponent = () => {
    ...
    const handlechangpdpa = async (event) => {
    ...
    return (
        <div>
            <ModelComponent valuechecked={valuechecked} setValueChecked={setValueChecked} showModal={showModal} setShowModal={setShowModal} />
            <NavbarComponent />
                    ...
                    <form className='max-w-[400px] w-full mx-auto bg-white pl-8 pr-8 md:pt-14 justify-center md:mt-16' onSubmit={Savepreliminaryinfomation} >
                        ...
                        <div className="flex flex-col py-4">
                            <div className="flex">
                                ...
                                <input required type="checkbox" onChange={handlechangpdpa} id="id-123"
                                    name="field-name" checked={valuechecked} className="w-3 h-3 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 form-radio" />
                                </div>
                                <div className="ml-2 text-sm">
                                    <label className="font-medium text-gray-900 dark:text-gray-300">{constant.PreliminaryContent.papa.title}</label>
                                    <p onClick={handlemodel} className="text-xs font-normal cursor-pointer text-blue-700 dark:text-gray-300 underline">{constant.PreliminaryContent.papa.des}</p>
                                </div>
                            </div>
                        </div>
