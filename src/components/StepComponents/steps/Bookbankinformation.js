...
export default function Bookbank({isMessageErrorBookbankPicture,isMessageErrorCriminalHistoryPicture,isResponseError}) {
  ...
  return (
    ...
    <div className="md:col-span-9">
      <h1 className="pb-2">กรอกข้อมูลบัญชีธนาคาร</h1>
      <div className="border rounded-2xl pl-6 pr-6 pt-6 ">
        <div className="grid md:grid-cols-2 md:gap-x-10 ">
        <div className='flex flex-col py-2 z-50'>
          <div className="relative z-0 mb-6 w-full group">
            <label htmlFor="exampleFormControlInput" className="form-label inline-blocktext-gray-700 pl-2 text-sm">ชื่อตามบัญชี</label>
            <input
              required
              ...
              placeholder="นายสมชาย" id="exampleInputNamebookbank"
            />
          </div>
        </div>
        <div className='flex flex-col py-2 z-0'>
          <div className="relative z-0 mb-6 w-full group">
            <label htmlFor="exampleFormControlInput" className="form-label inline-blocktext-gray-700 pl-2 text-sm">นามสกุลตามบัญชี</label>
            <input
              required
              onChange={handleChange}
              ...
              type="text"  
              className="block w-full pl-4 pb-1 font-normal text-gray-700 bg-white bg-clip-padding border-bottom border-solid border-gray-300 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
              placeholder="เข็มกลัด" id="exampleInputSurNamebookbank"
            />
          </div>
        </div>
        ...
        <div className='flex flex-col py-2'>
          <div className="relative z-0 mb-6 w-full group">
            <label htmlFor="exampleFormControlInput" className="form-label inline-blocktext-gray-700 pl-2 text-sm">เลขบัญชีธนาคาร</label>
            <input
              onChange={handleChange}
              required
              ...
              type="text"  
              className="block w-full pl-4 pb-1 font-normal text-gray-700 bg-white bg-clip-padding border-bottom border-solid border-gray-300 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
              placeholder="0000000" id="exampleInputIdbookbank"
            />
          </div>
        </div>
        <div className='flex flex-col py-2'>
          <div className="relative z-0 mb-6 w-full group">
            <label htmlFor="exampleFormControlInput" className="form-label inline-blocktext-gray-700 pl-2 text-sm">ชื่อธนาคาร</label>
            <input
              onChange={handleChange}
              required
              ...
              type="text"  
              className="block w-full pl-4 pb-1 font-normal text-gray-700 bg-white bg-clip-padding border-bottom border-solid border-gray-300 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
              placeholder="ธนาคารไทยพานิชณ์" id="exampleInputNamebank"
            />
          </div>
        </div>
        </div>
        <div className=" grid md:grid-cols-2 md:gap-x-0 pl-6 pr-6 pt-2 pb-6 ">
          <div className='flex flex-col py-2 text-center'>
            <div className="relative z-0 w-full group">
              <label htmlFor="exampleFormControlInput" className="form-label inline-blocktext-gray-700 pl-2 text-sm">รูปบัญชีธนาคารหน้าที่มีชื่อและเลขบัญชี</label>
                  ...
                  <label htmlFor="dropzone-file" className="flex flex-col justify-center items-center w-40 h-36 bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                      ...
                      {userData['bookbankphoto'] === undefined?
                          <>
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400">รูปภาพบัญชีธนาคาร</p>
                          </>
                            :
                          <>
              ...
              {isMessageErrorBookbankPicture === true?
                          <>
                            <label htmlFor="exampleFormControlInput" className="pl-2 pt-4 text-xs text-red-500">โปรดคลิกเพื่ออัพโหลดรูปบัญชีธนาคาร</label>
                          </>
                          :
                          <>
                          </>
          ...
          <div className='flex flex-col py-2'>
            <div className="relative z-0 w-full group text-center suggesstion-box pt-12">
              ...
              <h5 className="text-xs text-gray-500">ภาพถ่ายหน้าเลขสมุดบัญชีธนาคาร<br/>ตัวอักษรชัดเจน ไม่มีเงาสะท้อน</h5>
            </div>
          </div>
        </div>  
      </div>
  ...
  <h1 className="pb-2">เพิ่มเอกสารตรวจสอบประวัติอาญชกรรม</h1>
    ...
    <div className=" grid md:grid-cols-0 md:gap-x-0 pl-6 pr-6 pt-2 pb-0 ">
          <div className='flex flex-col py-2 text-center'>
            <div className="relative z-0 w-full group">
              <label htmlFor="exampleFormControlInput" className="form-label inline-blocktext-gray-700 pl-2 pb-4 text-sm">รูปประวัติตรวจสอบอาญชกรรม</label>
              <div className="flex justify-center items-center w-full">
                  <label htmlFor="dropzone-file-2" className="flex flex-col justify-center items-center w-40 h-36 bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                      ...
                      {userData['criminalhistoryphoto'] === undefined?
                          <>
                            ...
                            <FaCloudUploadAlt className="mb-2 mt-4 w-8 h-8 text-gray-600 z-20"></FaCloudUploadAlt>
                            <p className="mb-2 text-xs text-gray-500 dark:text-gray-400"><span className="font-semibold">คลิกเพื่ออัพโหลด</span></p>
                            <p className="text-xs text-gray-500 dark:text-gray-400">รูปภาพประวัติตรวจ<br/>สอบอาญชกรรม</p>
                          </>
                            :
                          <>
              ...
              {isMessageErrorCriminalHistoryPicture === true?
                          <>
                            <label htmlFor="exampleFormControlInput" className="pl-2 pt-4 text-xs text-red-500">โปรดคลิกเพื่ออัพโหลดรูปประวัติตรวจสอบอาญชกรรม</label>
                          </>
                          :
                          <>
                          </>
          ...
          <div className='flex flex-col py-2'>
            <div className="relative z-0 w-full group text-center suggesstion-box pt-10">
              <label htmlFor="exampleFormControlInput" className="form-label inline-blocktext-gray-700 pl-2 text-sm font-bold">คำแนะนำรูป</label>
              <h5 className="text-xs text-gray-500">ภาพตรวจสอบประวัติอาญชกรรม<br/>ตัวอักษรชัดเจน ไม่มีเงาสะท้อน</h5>
            </div>
          </div>
        </div>  
    </div> 
