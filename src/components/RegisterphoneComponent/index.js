            ...
            <NavbarComponent />
                <div className='grid grid-cols-1 sm:grid-cols-2 h-screen w-full'>    
                    ...
                    <div className='bg-white flex flex-col mb-14 pb-5'>
                        <div className='flex justify-end pr-10 pb-14 md:pt-3 md:mb-14 content-start'>
                            <img className='absolute w-14 h-14 object-cover photo mb-14' src={logo} alt="" />
                        </div>
                        <form onSubmit={requestotp}>  
                            <div className='max-w-[400px] w-full mx-auto bg-white pl-8 pr-8 md:pt-14 justify-center' >
                            {expandForm === false?
                                <>
                                <div>
