...
const ConfirmCodePage = ({userEmail, userPassword}) => {
    ...
    return (
        ...
        <div className='bg-white flex flex-col justify-center mb-14 pb-5'>
            ...
            <form className='max-w-[400px] w-full mx-auto bg-white pl-8 pr-8' onSubmit={confirmCode}>
                <h2 className='text-2xl font-bold text-left py-6'>กรอกข้อมูลผู้ใช้งานเบื้องต้น</h2>
